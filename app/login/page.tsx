...
export default function LoginPage() {
  return (
    <main className="mx-auto flex min-h-screen w-full max-w-6xl items-center px-3 py-6 sm:px-4 sm:py-10">
      <div className="grid w-full overflow-hidden rounded-2xl border bg-card shadow-sm sm:rounded-3xl lg:grid-cols-[1.1fr_0.9fr]">
